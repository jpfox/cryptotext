...
var cryptotext = (function() {
	...
	my.encrypt = function(plaintext, publickeystring, signingkey)
	{
		...
		if(signingkey)
		{
			signString   = cryptotext.b16to64(signingkey.signString(plaintext, "sha256"));
			content.k  = cryptotext.publicKeyString(signingkey);
...
alert('ciphertext:'+ciphertext);
		...
		else
		{
			...
			if(aeskey == null)
			{
				return {status: "Invalid AES block"};
			}
